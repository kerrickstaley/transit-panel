...
},{"./config.json":1,"./ids":2,"./pathOfficial":5,"./schedule":6,"./scheduleData":8}],4:[function(require,module,exports){
'use strict';
...
},{"./ids":2,"luxon":4}],6:[function(require,module,exports){
"use strict";
...
const idsToWeekSchedule = {
    ...
    [ids.WTC]: {
        [ids.HOBOKEN]: pathHobokenToWtcWeekSchedule,
    },
    [ids.HOBOKEN_FERRY]: {
