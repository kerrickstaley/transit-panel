...
function App() {
  return (
    <div>
      <PathRow origin="hoboken" route="world_trade_center" rowTitle="PATH to WTC" walkSec={600} />
      <PathRow origin="hoboken" route="thirty_third_street" rowTitle="PATH to 33rd" walkSec={600} />
